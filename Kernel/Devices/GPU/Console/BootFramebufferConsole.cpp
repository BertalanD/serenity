    ...
    : GenericFramebufferConsoleImpl(width, height, pitch)
{
    ...
    m_framebuffer = MM.allocate_kernel_region(framebuffer_addr.page_base(), framebuffer_end - framebuffer_addr.page_base().get(), "Boot Framebuffer"sv, Memory::Region::Access::Write, Memory::Region::Cacheable::No).release_value();
